...
## PHASE 2B · UNBLOCKING HOLMDEL  ·  `next`  (1/6)
...
- [ ] **GitHub repo velocity** — unblocked — GitHub's unauthenticated search API returns 200 locally (60 req/hour ceiling) — add as Holmdel's fourth surface
